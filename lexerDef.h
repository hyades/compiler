...
typedef enum
{
    ...
    TK_GLOBAL ,TK_IF ,TK_INPUT ,TK_INT ,TK_INT ,TK_LIST ,TK_OUTPUT ,TK_PARAMETER ,TK_PARAMETERS ,TK_READ ,
    TK_REAL ,TK_REAL ,TK_RECORD ,TK_RETURN ,TK_THEN ,TK_TYPE ,TK_WHILE ,TK_WITH ,TK_WRITE
} symbol;
